...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(nodeLink) { return nodeLink; };
  var peg$f2 = function(from, link, to) { return { from, link, to }; };
  var peg$f3 = function(id) { return { id }; };
  var peg$f4 = function(description) { return { description }; };
  ...
  function peg$parseNodeLinkNode() {
    var s0, s1, s2, s3;
